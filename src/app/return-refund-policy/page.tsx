...
const Page = () => {
  return (
    ...
    <p className='text-xl mb-4'> At Radiate, we want your shopping experience to be smooth, hassle-free, and enjoyable. We take great care in crafting and packaging our products, ensuring they reach you in perfect condition. 
    We are fully committed to promptly resolve any issues which may arise. Please read our policy carefully to ensure a seamless experience and to help you shop with confidence.</p>
    
    <div className='mt-12'>
    <h2 className='text-2xl font-bold mb-4'>Shipping policy</h2>
    
    We are pleased to offer shipping services across India. However, transit times may vary based on destination, courier delays, or unforeseen circumstances like weather disruptions or strikes. Below is everything you need to know about our shipping process.
    ...
    <h2 className='text-2xl font-bold mt-4'>Extended Shipping Delays</h2>
    <ul className='list-disc list-inside mt-4 ml-4'>
    ...
    <h2 className='text-2xl font-bold'>Accurate Shipping Details</h2>
    <ul className='list-disc list-inside mt-4 ml-4'>
    ...
    <h2 className='text-2xl font-bold mb-4'>Exchange, Return & Refund Policy</h2>
        ...
        <p>🚫 Sorry <span className='font-bold'>we do not offer returns or refunds for change of mind purchases.</span></p>
    ...
    <h2 className='text-2xl font-bold mt-4'>Modes of Payment</h2>
    <ul className='list-disc list-inside mt-4 ml-4'>
        <li>We accept:
    ...
    <p className='mt-4'>🚫 Currently, we do not offer Cash on Delivery (COD), but we will introduce it soon!</p>
    ...
    <h2 className='text-2xl font-bold mt-4'> Need Help? Contact Us!</h2>
    <p className='mt-4'>For any shipping-related queries, please feel free to contact us:</p>
    <ul className='list-disc list-inside mt-4 ml-4'>
        <li>📧 Email: <a href="mailto:radiatecandles24@gmail.com" className="text-[#500769] hover:underline">radiatecandles24@gmail.com</a></li>
        <li>📱 Instagram: <a href="https://www.instagram.com/letsradiate.in/" className="text-[#500769] hover:underline">https://www.instagram.com/letsradiate.in/</a>  </li>
        <li>💬 WhatsApp: <a href="https://wa.me/917011145443" className="text-[#500769] hover:underline">+91 7011145443</a></li>
    </ul>
