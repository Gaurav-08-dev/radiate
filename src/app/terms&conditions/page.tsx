    ...
    <main className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="space-y-6">
        <section>
          ...
          <section>
            <p className="mb-4">
              ...
              of domain name https://www. letsradiate.in/ ('Website'), including
          ...
          <section>
            <p className="mb-4">
              ...
              registered office at CHANDNI CHOWK CHANDNI CHOWK ,New Delhi ,India
          ...
          <section>
            <p className="mb-4">
              7. The use of Platform and/or availing of our Services is subject
            ...
            <ul className="list-inside list-disc space-y-4 pl-4">
              ...
              <li>
                ...
                links, you will be governed by the terms of use, privacy terms
                of use, privacy policy and such other policies of such third
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              <strong>https://www.letsradiate.in/</strong> (hereinafter referred
              to as Platform). Please note that you may be able to browse
              certain sections of the Platform without registering with us.We do
              not offer any product/service under this Platform outside India
            ...
            <p>
              ...
              choose to provide on our Platform. This information is compiled
              and analysed on an aggregated basis. We will also collect your
              ...
              person/association claiming to be SHRI BALAJI ELECTRONIC SERVICES
              seeking any personal data like debit/credit card PIN, net-banking
              or mobile banking password, we request you to never provide such
            ...
            <p>
              ...
              and protect us against error, fraud and other detect and protect
            ...
            <p>
              ...
              sharing unless you explicitly opt-out. We may disclose personal
              data to third parties such as sellers, business partners, third
              party service providers including logistics partners, prepaid
              ...
              marketing and advertising activities, to prevent, detect,
            ...
            <p>
              ...
              information is not completely secure for reasons beyond our
            ...
            <h3 className="text-lg font-medium">Data Deletion and Retention</h3>
            <p>
              ...
              these requests. We may in event of any pending grievance, claims,
              pending shipments or any other services we may refuse or delay
              deletion of the account. Once the account is deleted, you will
              lose access to the account. We retain your personal data
              information for a period no longer than is required for the
            ...
            <p>
              ...
              in accordance with this Privacy Po licy. You, while providing your
              ...
              e-mail for the purposes specified in this Privacy Policy. You have
              an option to withdraw your consent that you have already provided
              by writing to the Grievance Officer at the contact information
              provided below. Please mention “Withdrawal of consent for
              processing personal data” in your subject line of your
        ...
        <section>
          ...
          <div className="space-y-4">
            We offer refund / exchange within first 7 days from the date of your
            ...
            quality check at our end, quality check at our end, your request
            (i.e. return / exchange) will be processed in accordance with our
            policies.
          </div>
        </section>
