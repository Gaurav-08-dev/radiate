...
export default async function TermsAndConditions() {
  ...
  const returnPolicy = checkoutSettings?.checkoutPolicies?.returnPolicy?.content?.split("\n");
  const termsAndConditions =
    checkoutSettings?.checkoutPolicies?.termsAndConditions?.content?.split("\n");
  const privacyPolicy = checkoutSettings?.checkoutPolicies?.privacyPolicy?.content?.split("\n");
