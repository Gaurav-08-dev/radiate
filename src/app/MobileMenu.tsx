                        ...
                        <div className="flex flex-col gap-4">
                          ...
                          {featuredProducts && featuredProducts.length > 0 && (
                            <div className="mt-4 flex flex-col gap-4">
                              ...
                              <Link
                                href="/shop"
                                className="ml-[27%] mt-4 w-fit border border-purple-600 p-2 text-sm font-medium text-purple-600 hover:text-purple-800"
                                onClick={resetSearch}
                              >
                              ...
                              <div className="flex flex-col justify-between gap-4">
                                ...
                                <div className="flex flex-col gap-2">
                                  <div className="font-medium">
                                    {result.priceData?.formatted
                                      ?.discountedPrice ||
                                      result.price?.formatted?.price}
                                  </div>
                                  <AddToCartButton
