...
export const getCollectionsForHeader = cache(
  async (wixClient: WixClient): Promise<collections.Collection[]> => {
    ...
    const collection = await wixClient.collections.queryCollections()
    .hasSome("_id",["79f1e1c4-9d44-8a1a-ebcc-3c840d3b4d37","dd036eb5-7484-5053-e35e-d3fc046f6417","e47a30b0-abed-082b-89e5-771ea279deae","e8752ab7-08e0-39a7-5fc8-88df885512b7"])
    .find()
